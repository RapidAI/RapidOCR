...
def init_args():
    ...
    det_group.add_argument("--det_gpu_mem", type=int, default=500)
    ...
    cls_group.add_argument("--cls_gpu_id", type=int, default=0)
    cls_group.add_argument("--cls_gpu_mem", type=int, default=500)
