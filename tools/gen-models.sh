...
paddle2onnx --model_dir models/ch_ppocr_mobile_v2.0_cls_infer/  --model_filename  inference.pdmodel --params_filename inference.pdiparams --save_file models/ch_ppocr_mobile_v2.0_cls_infer.onnx --opset_version 12 --enable_onnx_checker True
...
paddle2onnx --model_dir models/ch_ppocr_mobile_v2.0_det_infer/  --model_filename  inference.pdmodel --params_filename inference.pdiparams --save_file models/ch_ppocr_mobile_v2.0_det_infer.onnx --opset_version 12 --enable_onnx_checker True

# ======ch_ppocr_mobile_v2.0_rec failed======
...
#paddle2onnx --model_dir models/ch_ppocr_mobile_v2.0_rec_infer/  --model_filename  inference.pdmodel --params_filename inference.pdiparams --save_file models/ch_ppocr_mobile_v2.0_rec_infer.onnx --opset_version 12 --enable_onnx_checker True
...
paddle2onnx --model_dir models/ch_ppocr_server_v2.0_det_infer/  --model_filename  inference.pdmodel --params_filename inference.pdiparams --save_file models/ch_ppocr_server_v2.0_det_infer.onnx --opset_version 12 --enable_onnx_checker True
...
paddle2onnx --model_dir models/ch_ppocr_server_v2.0_rec_infer/  --model_filename  inference.pdmodel --params_filename inference.pdiparams --save_file models/ch_ppocr_server_v2.0_rec_infer.onnx --opset_version 12 --enable_onnx_checker True
